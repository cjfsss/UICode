 ...
 * @date : 2020/4/1 21:12
 */
public class ChipBottomSubtitleItem extends SubtitleGroupItem<ChipBottomSubtitleItem> implements ChipAction<ChipBottomSubtitleItem>, CompoundAction<ChipBottomSubtitleItem> {
    ...
    public ChipBottomSubtitleItem(Context context) {
        this(context, null);
    }

    public ChipBottomSubtitleItem(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ChipBottomSubtitleItem(Context context, AttributeSet attrs, int defStyleAttr) {
