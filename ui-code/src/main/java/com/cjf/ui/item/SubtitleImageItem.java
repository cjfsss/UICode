 ...
 * @date : 2020/4/1 21:12
 */
public class SubtitleImageItem extends SubtitleGroupItem<SubtitleImageItem> implements RightTextAction<SubtitleImageItem> {

    private View mSpaceView;
    private AppCompatTextView mRightView;

    public SubtitleImageItem(Context context) {
        this(context, null);
    }

    public SubtitleImageItem(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SubtitleImageItem(Context context, AttributeSet attrs, int defStyleAttr) {
