 ...
 * @date : 2020/4/1 21:12
 */
public class ChipRightSubtitleItem extends SubtitleGroupItem<ChipRightSubtitleItem> implements ChipAction<ChipRightSubtitleItem> {

    private ChipGroupLayout mChipGroup;
    private View mSpaceView;

    public ChipRightSubtitleItem(Context context) {
        this(context, null);
    }

    public ChipRightSubtitleItem(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ChipRightSubtitleItem(Context context, AttributeSet attrs, int defStyleAttr) {
