 ...
 * @date : 2020/4/1 21:12
 */
public class SubtitleItem extends SubtitleGroupItem<SubtitleItem> {

    public SubtitleItem(Context context) {
        this(context, null);
    }

    public SubtitleItem(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SubtitleItem(Context context, AttributeSet attrs, int defStyleAttr) {
