 ...
 * @date : 2020/4/1 18:44
 */
public abstract class CompoundItem<T extends ItemGroupView<T>> extends ItemGroupView<T> implements CompoundAction<T> {
    ...
    public CompoundItem(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CompoundItem(Context context, AttributeSet attrs, int defStyleAttr) {
