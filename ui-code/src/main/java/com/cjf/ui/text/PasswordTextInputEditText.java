 ...
 */
public final class PasswordTextInputEditText extends RegexTextInputEditText
    ...
    public PasswordTextInputEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mVisibleDrawable = DrawableCompat.wrap(ContextCompat.getDrawable(context, R.drawable.x_et_svg_ic_hide_password_24dp));
        mVisibleDrawable.setBounds(0, 0, mVisibleDrawable.getIntrinsicWidth(), mVisibleDrawable.getIntrinsicHeight());

        mInvisibleDrawable = DrawableCompat.wrap(ContextCompat.getDrawable(context, R.drawable.x_et_svg_ic_show_password_24dp));
